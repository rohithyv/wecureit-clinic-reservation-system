...
export default function Home() {
  ...
  return (
    <div className="animate-in fade-in duration-700 bg-[#FBFCFD] theme-rose">
      <section className="bg-[#E11D48] text-white py-28 px-6 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-[420px] h-[420px] bg-rose-200/20 rounded-full blur-3xl pointer-events-none hero-orb-float-delayed" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-rose-50/70 text-lg md:text-xl mb-12 max-w-2xl mx-auto leading-relaxed font-medium">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[10px] font-black text-rose-600 uppercase tracking-[0.4em] mb-3 block">Official Registry</span>
...
function FeatureCard({ icon, title, desc }) {
  return (
    <div className="group text-center">
      <div className="w-20 h-20 rounded-[2rem] bg-rose-50 flex items-center justify-center mx-auto mb-6 group-hover:bg-[#E11D48] group-hover:text-white transition-all duration-500">
        <div className="text-rose-700 group-hover:text-white transition-colors">{icon}</div>
      </div>
